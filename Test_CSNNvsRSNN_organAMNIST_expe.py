...
image_size = 128 #224 #64 #64 #128 #128
n_steps = 5
batch_size = 64
n_output = 11
...
model_name = "VIT_RSNN"
message ="VIT_RSNN on OrganAMNIST seed 3" #L2 reg  #prunning #"add_transformation_noNoise"
n_hidden = 1000
...
if wandb_rec == True:
    ...
    run = wandb.init(
        ...
        name = f'VIT_R_{random_num} - Img_size={image_size}',
...
if __name__ == "__main__":
    ...
    """train_acc_hist_csnn = np.array(train_acc_hist_csnn)
    val_acc_hist_csnn = np.array(val_acc_hist_csnn)
    val_auroc_hist_csnn = np.array(val_auroc_hist_csnn)
    loss_csnn = np.array(loss_csnn)"""
    ...
    "CSNN": {
                "acc_train":  train_acc_avg_csnn,
                "acc_test": val_acc_avg_csnn,
                "auroc_test": val_auroc_avg_csnn,
                "loss": loss_csnn_avg,
                "mean_training_time": mean_training_time_CSNN,
                "mean_inference_time": mean_inf_time_CSNN
            },}
